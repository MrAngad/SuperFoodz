...
contract Token is ERC20, Pausable, Ownable, ERC20Capped {
    ...
    constructor(
        ...
        uint256 _maxSupply
    ) ERC20(_name, _symbol) ERC20Capped(_maxSupply * 10**18) {
    ...
    function getAmountVested(address user) public view returns (uint256) {
